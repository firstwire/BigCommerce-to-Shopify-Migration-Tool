...
Create a new folder on your Desktop (for example, “BC-to-Shopify”). Inside it, create another folder called “input” — this is where all your BigCommerce export files will go.
